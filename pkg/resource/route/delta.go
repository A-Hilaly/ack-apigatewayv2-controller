...
func newResourceDelta(
	...
	if ackcompare.HasNilDifference(a.ko.Spec.RequestParameters, b.ko.Spec.RequestParameters) {
		...
		if !equalRouteParameters(a.ko.Spec.RequestParameters, b.ko.Spec.RequestParameters) {
			delta.Add("Spec.RequestParameters", a.ko.Spec.RequestParameters, b.ko.Spec.RequestParameters)
		}
	}
...
func equalRouteParameters(a, b map[string]*svcapitypes.ParameterConstraints) bool {
	if len(a) != len(b) {
		return false
	}
	for ka := range a {
	...
	for ka, aX := range a {
		bY := b[ka]
		if ackcompare.HasNilDifference(aX.Required, bY.Required) {
			return false
		} else if aX.Required != nil && bY.Required != nil {
			if *aX.Required != *bY.Required {
				return false
			}
		}
	}
